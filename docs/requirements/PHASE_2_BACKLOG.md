...
| **Status** | **Planned.** The deployment guide (`docs/cloud-database-setup.md`) and the verification script (`scripts/verify_cloud_database.py`) exist. **No cloud database has been deployed.** A guide is not an instance. |
