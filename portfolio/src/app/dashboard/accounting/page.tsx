  ...
  return (
    <Canvas>
      <PageHeader
        ...
        lede="The inventory subledger against the selected synthetic GL inventory control accounts, at one comparison date. The variance is general ledger minus subledger, so a positive figure means the ledger carries more than the schedule supports. This is an inventory control reconciliation and not a general ledger: no journal entry, trial balance or financial statement exists in this project."
        dashboardNav
        ...
        meta={
          <>
            ...
            <Badge tone="neutral" mono>
              {comparisonDate === null
                ? 'No comparison date'
                : `Comparison ${formatIsoDate(comparisonDate)}`}
            </Badge>
          ...
          <div className="flex flex-col gap-6">
            ...
            <dl className="grid gap-4 border-y border-line py-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="flex flex-col gap-0.5">
                ...
                <dd className="text-sm text-ink">Matched accounting and balance date</dd>
              </div>
              <div className="flex flex-col gap-0.5">
                <dt className="text-xs uppercase tracking-wide text-ink-muted">
                  Positions
                </dt>
                <dd className="text-sm text-ink">{summary.totalPositions}</dd>
              </div>
              <div className="flex flex-col gap-0.5">
            ...
            <Disclosure label="What this page reconciles, and what it does not">
              <div className="flex flex-col gap-3">
                <Text size="sm">
                  ...
                  model. It is not agreement between two independent systems, and no
                  figure here is an audit, a certification or an external validation.
                </Text>
