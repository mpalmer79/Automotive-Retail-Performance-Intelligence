...
import { formatDateRange, formatIsoMonth } from '@/lib/dashboard/format'
        ...
        ? [
            {
              ...
              href: filtersHref(ROUTES.dashboardFi.href, {
                ...parsed.filters,
          ...
          ? [
              {
                ...
                href: filtersHref(ROUTES.dashboardLeadsMarketing.href, {
                  ...parsed.filters,
                  employee: null,
                }),
          ...
          : [
              {
                ...
                href: filtersHref(ROUTES.dashboardSalesGross.href, {
                  ...parsed.filters,
                  employee: null,
                }),
  ...
  return (
    <Canvas>
      <PageHeader
        ...
        title="What was credited to each person, and what came with it"
        crumbLabel="Employees"
        lede="Four operating surfaces with different opportunities and different governed denominators. Every comparative figure carries the denominator it was computed over and is withheld below the minimum sample, because a ratio over six deliveries is not a comparison. Every employee here is synthetic and identified only by a code; there is no ranking, no score and no personnel data on this page."
        dashboardNav
        ...
        meta={
          <>
            ...
            <Badge tone="neutral" mono>
              {formatDateRange(scope.period.start, scope.period.end)}
            </Badge>
          ...
          <div className="flex flex-col gap-6">
            ...
            <dl className="grid gap-4 border-y border-line py-4 sm:grid-cols-2 lg:grid-cols-4">
              <div className="flex flex-col gap-0.5">
                ...
                <dd className="text-sm text-ink">{scope.period.label}</dd>
              </div>
              <div className="flex flex-col gap-0.5">
                <dt className="text-xs uppercase tracking-wide text-ink-muted">
                  Role family
                </dt>
                <dd className="text-sm text-ink">{view.family}</dd>
              </div>
              <div className="flex flex-col gap-0.5">
                <dt className="text-xs uppercase tracking-wide text-ink-muted">
                  Attribution
                </dt>
                <dd className="text-sm text-ink">Credited role and store at the event</dd>
              </div>
              <div className="flex flex-col gap-0.5">
