  ...
  return (
    <Canvas>
      <PageHeader
        ...
        title="What the leads did, and what the marketing bought"
        crumbLabel="Leads and marketing"
        lede="The lead-created cohort from arrival to delivery, how quickly the stores answered and how many leads they never answered, where progression stopped, and spend against the outcomes attributed to it. Lead measures count leads on the date they arrived; appointment measures count appointments on their own two dates; marketing is monthly. Every figure comes from the governed SQL export."
        dashboardNav
          ...
          <div className="flex flex-col gap-6">
            ...
            <dl className="grid gap-4 border-y border-line py-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="flex flex-col gap-0.5">
                ...
                <dd className="text-sm text-ink">Lead creation date</dd>
              </div>
              <div className="flex flex-col gap-0.5">
                <dt className="text-xs uppercase tracking-wide text-ink-muted">
                  Marketing grain
                ...
                <dd className="text-sm text-ink">
                  {view.marketing.monthGrainUnavailable
                    ...
                    : `${String(view.marketing.wholeMonths.length)} whole month${
                        view.marketing.wholeMonths.length === 1 ? '' : 's'
                      }`}
                </dd>
              </div>
              <div className="flex flex-col gap-0.5">
