...
├── data/              raw/ (gitignored) · sample/ (committed) · reference/ (sanitized
│                      public inventory workbooks, one per store per snapshot) · external/
...
└── portfolio/         Next.js website: thirteen indexable routes over the documented
...
See [`data/reference/inventory/README.md`](data/reference/inventory/README.md) and [`portfolio/docs/CONTENT_MODEL.md`](portfolio/docs/CONTENT_MODEL.md) section 11.
