...
-- STATUS
-- ------
-- The table exists, is constrained, and is loaded by sql/04_facts/13_fact_appointment_load.sql on every
...
-- than passing quietly. warehouse.fact_appointment is projected for reporting without
