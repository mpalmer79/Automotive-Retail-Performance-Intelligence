...
def _product(  # noqa: PLR0913 - one keyword per catalogue attribute; collapsing them into a
    # tuple or a dict would make the nineteen call sites below unreadable and would lose the
    # type checker's help on exactly the values a typo would corrupt silently.
    ordinal: int,
    name: str,
    category: str,
    provider: str,
...
FINANCE_PRODUCT_DEFINITIONS: Final[tuple[FinanceProductDefinition, ...]] = (
    ...
    _product(
        1,
        "Granite Shield Powertrain Plus",
        "Vehicle Service Contract",
        FICTIONAL_PROVIDERS[0],
        60,
        cancellable=True,
        chargeback=True,
        gross_weight="1.00",
    ...
    _product(
        2,
        "Northbridge Comprehensive Coverage",
        "Vehicle Service Contract",
        FICTIONAL_PROVIDERS[1],
        72,
        cancellable=True,
        chargeback=True,
        gross_weight="1.22",
    ...
    _product(
        3,
        "Summit Certified Extended Coverage",
        "Vehicle Service Contract",
        FICTIONAL_PROVIDERS[3],
        84,
        cancellable=True,
        chargeback=True,
        gross_weight="1.35",
    ...
    _product(
        4,
        "Keystone GAP Advantage",
        "GAP",
        FICTIONAL_PROVIDERS[2],
        72,
        cancellable=True,
        chargeback=True,
        gross_weight="0.46",
    ...
    _product(
        6,
        "Granite Shield Road Hazard Tire and Wheel",
        "Tire & Wheel",
        FICTIONAL_PROVIDERS[0],
        36,
        cancellable=True,
    ...
    _product(
        8,
        "Keystone Scheduled Maintenance Plan",
        "Prepaid Maintenance",
        FICTIONAL_PROVIDERS[2],
        36,
        cancellable=True,
    ...
    _product(
        9,
        "Granite Shield Maintenance Essentials",
        "Prepaid Maintenance",
        FICTIONAL_PROVIDERS[0],
        24,
        cancellable=True,
    ...
    _product(
        10,
        "Northbridge Interior and Exterior Shield",
    ...
    _product(
        13,
        "Granite Shield Theft Deterrent Registration",
        "Theft or Security Product",
        FICTIONAL_PROVIDERS[0],
        60,
        cancellable=False,
    ...
    _product(
        16,
        "Keystone Lease Wear and Tear Waiver",
    ...
    _product(
        17,
        "Northbridge Lease End Protection",
        "Lease Wear Protection",
        FICTIONAL_PROVIDERS[1],
        39,
        cancellable=True,
    ...
    _product(
        18,
        "Summit Windshield Protection Plan",
        "Other Aftermarket Product",
        FICTIONAL_PROVIDERS[3],
        36,
        cancellable=False,
    ...
    _product(
        19,
        "Granite Shield Roadside Assistance Plus",
        "Other Aftermarket Product",
        FICTIONAL_PROVIDERS[0],
        60,
        cancellable=False,
...
# ---------------------------------------------------------------------------------------
#: A sensitivity flag must take BOTH values across the catalogue, not merely be boolean.
#: A column that is ``false`` everywhere is decoration, and the adjustment generator's
#: respect for it would never be exercised.
_BOTH_BOOLEAN_VALUES: Final = 2
...
def _check_sensitivity_flags(frame: pd.DataFrame) -> CheckResult:
    ...
    for column in ("cancellation_sensitive", "chargeback_sensitive"):
        ...
        elif len(values) < _BOTH_BOOLEAN_VALUES:
